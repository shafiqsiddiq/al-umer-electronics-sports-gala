    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {["A", "B", "C"].map((section) => (
          <div key={section} className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-700">
            ...
            <p className="text-sm text-zinc-500">Qualified: {summary.sections?.[section]?.qualified || 0}/2</p>
          </div>
        ))}
      </div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-700">
          ...
          <p className="text-sm text-zinc-500">Loser Pool: {summary.loserBracket?.pool || 0}/24</p>
          <p className="text-sm text-zinc-500">Qualified: {summary.loserBracket?.qualified || 0}/2</p>
        </div>
        <div className="rounded-xl border border-zinc-200 p-4 dark:border-zinc-700">
          <h2 className="mb-3 font-semibold">Final Stage</h2>
          <p className="text-sm text-zinc-500">Teams: {summary.finalEight?.teams || 0}/8</p>
